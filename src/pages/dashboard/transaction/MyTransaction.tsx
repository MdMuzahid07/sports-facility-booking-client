...
const MyTransaction = () => {
    ...
    const paidBookings = myBookings?.filter((paidBooking: any) => paidBooking?.isBooked === "confirmed");
    ...
    const currentItems = useMemo(() => {
        ...
        return paidBookings?.slice(startIndex, endIndex);
    }, [paidBookings, currentPage]);
