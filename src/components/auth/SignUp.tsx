                            ...
                            <div className="grid w-full items-center gap-4">
                                <div className="grid sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex flex-col space-y-1.5">
                                        ...
                                        <Input
                                            ...
                                            type="email" className="rounded-full drop-shadow-sm" id="email" placeholder="Your email address"
                                ...
                                <div className="grid sm:grid-cols-2 gap-4">
                                    <div className="flex flex-col space-y-1.5">
                                        ...
                                        <Input {...register("phone", { required: true })} type="text" className="rounded-full drop-shadow-sm" id="phone" placeholder="Contact number"
                                    ...
                                    <div className="flex flex-col space-y-1.5">
                                        ...
                                        <Input {...register("password", { required: true })} type="password" className="rounded-full drop-shadow-sm" id="pass" placeholder="Add a strong password"
                                    ...
                                    <div className="flex flex-col space-y-1.5">
                                        ...
                                        <Textarea {...register("address", { required: true })} className="rounded-2xl drop-shadow-sm" id="pass" placeholder="Add a strong password"
                                            aria-invalid={errors.address ? "true" : "false"}
                                        />
                                    </div>
                                </div>
                                <div className="text-slate-600">
                                    <small>Have account? <span className="font-bold text-black"><NavLink to="/login">Login</NavLink></span></small>
                                </div>
                            </div>
